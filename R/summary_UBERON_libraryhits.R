...
summary_UBERON_libraryhits <- function(){
  ...
  print(plot_summary)
  ggsave(file="GNPS_LibraryHitTable_SummaryPercentage_UBERON.pdf", width = 3.25, height = 3.25, units = "in", dpi=300, useDingbats=FALSE)
  ggsave(file="GNPS_LibraryHitTable_SummaryPercentage_UBERON.png", width = 3.25, height = 3.25, units = "in")
  ...
  zipr("zip_UBERON.zip", c("GNPS_hittable_UBERONTag.csv",
                           "GNPS_LibraryHitTable_Summary_UBERON.pdf", 
                           "GNPS_LibraryHitTable_Summary_UBERON.png",
                           "GNPS_LibraryHitTable_SummaryPercentage_UBERON.pdf", 
                           "GNPS_LibraryHitTable_SummaryPercentage_UBERON.png",
