#' Summary of NCBI Taxonomy Tags in GNPS - Library Annotations
#'
#' This function works to generate a summary of the NCBI taxonomy tags associated with annotated chemicals resulting from spectral library matching in GNPS. NCBI taxonomy tags are associated with planar InChIKeys.
...
#' @export
#'
summary_NCBI_libraryhits <- function(){
  ...
  if (nrow(df_libraryhits_tags) > 0) {
    ...
    tags <- cbind(df_libraryhits_tags[,"InChIKey-Planar"],separate(df_libraryhits_tags[,"NCBITaxonomy"], NCBITaxonomy, paste0("X",1:max(sapply(strsplit(df_libraryhits_tags$NCBITaxonomy,":"),length))), sep=":"))
  ...
  print(plot_summary)
  ggsave(file="GNPS_LibraryHitTable_Summary_NCBI.pdf", width = 3.25, height = 3.25, units = "in", dpi=300, useDingbats=FALSE)
  ggsave(file="GNPS_LibraryHitTable_Summary_NCBI.png", width = 3.25, height = 3.25, units = "in")
  ...
  print(plot_summary)
  ggsave(file="GNPS_LibraryHitTable_SummaryPercentage_NCBI.pdf", width = 3.25, height = 3.25, units = "in", dpi=300, useDingbats=FALSE)
  ggsave(file="GNPS_LibraryHitTable_SummaryPercentage_NCBI.png", width = 3.25, height = 3.25, units = "in")
  ...
  zipr("zip_NCBI.zip", c("GNPS_hittable_NCBITaxonomyTag.csv",
                           ...
                           "GNPS_LibraryHitTable_SummaryPercentage_NCBI.png",
