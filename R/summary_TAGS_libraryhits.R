#' Summary of GNPS Tags - Library Annotations
#'
#' This function works to generate a summary of the GNPS Tags associated with annotated chemicals resulting from spectral library matching in GNPS. Tags are associated with planar InChIKeys.
...
#' @export
#'
summary_TAGS_libraryhits <- function(){
  ...
  print(plot_summary)
  ggsave(file="GNPS_LibraryHitTable_Summary_TAG.pdf", width = 3.25, height = 3.25, units = "in", dpi=300, useDingbats=FALSE)
  ggsave(file="GNPS_LibraryHitTable_Summary_TAG.png", width = 3.25, height = 3.25, units = "in")
  ...
  print(plot_summary)
  ggsave(file="GNPS_LibraryHitTable_SummaryPercentage_TAG.pdf", width = 3.25, height = 3.25, units = "in", dpi=300, useDingbats=FALSE)
  ggsave(file="GNPS_LibraryHitTable_SummaryPercentage_TAG.png", width = 3.25, height = 3.25, units = "in")
  ...
  zipr("zip_TAGS.zip", c("GNPS_hittable_TAGS.csv",
                         ...
                         "GNPS_LibraryHitTable_SummaryPercentage_TAG.png",
                         "numbers_TAGS.csv"))
  }
